...
star_graphic::star_graphic(glm::vec4 color, glm::vec2 pos, glm::vec2 scale) : star_mesh(
                                                                                  {Vertex{
...
void star_graphic::show() {
    m_shader.bind();
    m_shader.uniform_int("sprite", 69);
...
void star_graphic::show(star_shader &shader) {
